...
export const home = {
  ...
  updates: [
    '正在补齐个人站的内容结构，让主页、文章、项目和近况能互相连接。',
    '最近重新梳理了自己的设计偏好：更克制的层次、更自然的中文表达、更稳的交互细节。',
    '下一步会继续补充真实项目案例，把这里慢慢经营成一个能代表自己的长期空间。'
  ],
    ...
    items: [
      {
        title: '个人主页与博客系统',
        meta: '静态生成 / 内容优先',
        text: '用最小但完整的静态方案支撑多页内容站，让写作、展示与后续迭代都更轻盈。'
      },
      {
        title: '案例型产品介绍页',
        meta: '品牌表达 / 页面叙事',
        text: '擅长把复杂信息拆成更顺的阅读节奏，在不吵闹的设计里建立可信度。'
      },
      {
        title: '个人知识与写作工作流',
        meta: '方法沉淀 / 长期复利',
        text: '围绕选题、草稿、归档与再利用，形成适合个人创作者的内容系统。'
      }
    ]
  },
  blog: {
